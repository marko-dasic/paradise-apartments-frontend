...
(function ($) {
    ...
    // window load event
    // ispravljanje greska priliko povratka na vec ucitanu komponentu u angularu
    try{
      ZeznutaFunkcija();
      thmOwlInit();
    }catch{console.log("uso u catch")}
    
    //
    $(window).on("load", function (){ZeznutaFunkcija()})
  
    function ZeznutaFunkcija(){
      if ($(".preloader").length) {
        $(".preloader").fadeOut();
      }
      thmSwiperInit();
